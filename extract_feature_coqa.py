...
if __name__ == '__main__':
    ...
    stride = 128
    ratio = 1
    cached_features_file = "preprocessing_files/bert/CoQA/dev_clean"
    ...
    features, dataset = convert_examples_to_features(examples, tokenizer=tokenizer, doc_stride=stride,  is_training=is_training, threads=8)
