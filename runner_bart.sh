...
#training
python main_bart_doqa.py --config bart-official-config-train/DoQA/train_config_hf_bart_base.yaml

# evaluating
# python eval_bart_doqa.py --config bart-official-config-eval/DoQA/eval_config_hf_bart_base_cooking.yaml
# python eval_bart_doqa.py --config bart-official-config-eval/DoQA/eval_config_hf_bart_base_movies.yaml
# python eval_bart_doqa.py --config bart-official-config-eval/DoQA/eval_config_hf_bart_base_travel.yaml
