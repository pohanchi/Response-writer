...
# testing
CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_cooking.yaml
CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_movies.yaml
CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_travel.yaml

# CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_cooking_noq.yaml
# CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_movies_noq.yaml
# CUDA_VISIBLE_DEVICES=0 python different_decoding_doqa.py --config bert-official-config-eval/DoQA/diff_decoding/eval_config_baseline_bert_base_travel_noq.yaml