...
def convert_example_to_features(example, tokenizer, doc_stride, padding_strategy, is_training):
    ...
    if len(indexes[0])==1:
        ...
        for i in range(len(indexes)-1):
            ...
            if i == 0:
                question_start = indexes[i]+1
                question_len = indexes[i+1]+1
    ...
    for span in spans:
        ...
        # print(span["input_ids"],span["attention_mask"])
        features.append(
            RCFeatures(
                span["input_ids"],
                span["attention_mask"],
...
if __name__ == "__main__":
    ...
    doqa_dataset = load_dataset("doqa",domain,cache_dir="./doqa")
    stride = 128
    cached_features_file = "doqa_test_file_movies"
