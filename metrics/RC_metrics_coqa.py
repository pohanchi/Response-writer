...
def compute_predictions_logits(
    ...
    _PrelimPrediction = collections.namedtuple(  # pylint: disable=invalid-name
        "PrelimPrediction", ["feature_index", "start_index", "end_index", "start_logit", "end_logit", "class_logits"]
    )
    ...
    for (example_index, example) in enumerate(all_examples):
        ...
        if not nbest:
            nbest.append(_NbestPrediction(text="empty", start_logit=-100.0, end_logit=-100.0))
