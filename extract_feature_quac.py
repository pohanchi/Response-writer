...
def convert_example_to_features(example, tokenizer, doc_stride, padding_strategy, is_training, sep_token_id):
    ...
    indexes = np.where(np.array(truncated_query) == sep_token_id)
...
if __name__ == '__main__':
    ...
    features, dataset = convert_examples_to_features(examples, tokenizer=tokenizer, doc_stride=config['stride'],  is_training=config['is_training'], sep_token_id=config['sep_token_id'])
